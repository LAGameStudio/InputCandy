if ( loaded && !processed ) {
	draw_sprite_ext(s_SDLDB_Loading_Disc,1,x,y,4.0,4.0,0,c_white,__INPUTCANDY.SDLDB_Process_Completeness);
	draw_set_halign(fa_center);
	draw_text(x,y+64,"Processed "+int(complete*100)+"%");
	...
	draw_sprite_ext(s_SDLDB_Loading_Disc,2,x,y,4.0,4.0,0,c_white,remaining/duration);
	draw_set_halign(fa_center);
	draw_text(x,y+64,"Complete!\nLoaded "+int(global.SDLDB_Entries)+" gamepads!");
	draw_set_halign(fa_left);
}